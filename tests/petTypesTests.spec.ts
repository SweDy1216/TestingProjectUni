...
test.describe.serial('Check specialty functionality', () => {
  ...
  test('Create pet type', async () => {
    ...
    const testValue = 'TestKholodnitskyi';
    ...
    await test.step(`Verify that last pet type in the list is recently added '${testValue}'`, async () => {
  ...
  test('Edit pet type', async () => {
    const updatedValue = 'TestKholodnitskyiUpdated';
    ...
    await test.step('Verify that the data of pet type was updated', async () => {
  ...
  test('Delete pet type', async () => {
    ...
    await test.step('Verify that the count of items was changed 1 after delete', async () => {
